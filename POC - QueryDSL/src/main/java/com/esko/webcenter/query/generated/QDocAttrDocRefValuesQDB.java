...
/**
 * QDocAttrDocRefValuesQDB is a Querydsl query type for QDocAttrDocRefValuesQDB
 */
@Generated("com.querydsl.sql.codegen.MetaDataSerializer")
public class QDocAttrDocRefValuesQDB extends com.querydsl.sql.RelationalPathBase<QDocAttrDocRefValuesQDB> {

    private static final long serialVersionUID = 298200257;

    public static final QDocAttrDocRefValuesQDB DocAttrDocRefValuesQ = new QDocAttrDocRefValuesQDB("Doc_Attr_DocRef_ValuesQ");
    ...
    public QDocAttrDocRefValuesQDB(String variable) {
        super(QDocAttrDocRefValuesQDB.class, forVariable(variable), "webcenter", "Doc_Attr_DocRef_ValuesQ");
        addMetadata();
    }

    public QDocAttrDocRefValuesQDB(String variable, String schema, String table) {
        super(QDocAttrDocRefValuesQDB.class, forVariable(variable), schema, table);
        addMetadata();
    }

    public QDocAttrDocRefValuesQDB(String variable, String schema) {
        super(QDocAttrDocRefValuesQDB.class, forVariable(variable), schema, "Doc_Attr_DocRef_ValuesQ");
        addMetadata();
    }

    public QDocAttrDocRefValuesQDB(Path<? extends QDocAttrDocRefValuesQDB> path) {
        super(path.getType(), path.getMetadata(), "webcenter", "Doc_Attr_DocRef_ValuesQ");
        addMetadata();
    }

    public QDocAttrDocRefValuesQDB(PathMetadata metadata) {
        super(QDocAttrDocRefValuesQDB.class, metadata, "webcenter", "Doc_Attr_DocRef_ValuesQ");
        addMetadata();
    }
    ...
    public void addMetadata() {
        ...
        addMetadata(dOCREFAppCycle, ColumnMetadata.named("DOCREF_AppCycle").withIndex(22).ofType(Types.SMALLINT).withSize(5));
        addMetadata(dOCREFAppStatus, ColumnMetadata.named("DOCREF_AppStatus").withIndex(21).ofType(Types.NVARCHAR).withSize(16));
        ...
        addMetadata(dOCREFDocId, ColumnMetadata.named("DOCREF_DocId").withIndex(20).ofType(Types.NVARCHAR).withSize(16));
        addMetadata(dOCREFDocname, ColumnMetadata.named("DOCREF_docname").withIndex(19).ofType(Types.NVARCHAR).withSize(256));
        addMetadata(dOCREFDocTypeId, ColumnMetadata.named("DOCREF_DocTypeId").withIndex(24).ofType(Types.NVARCHAR).withSize(16));
        ...
        addMetadata(dOCREFVersionCounter, ColumnMetadata.named("DOCREF_VersionCounter").withIndex(23).ofType(Types.SMALLINT).withSize(5));
        addMetadata(dRPROPAttrId, ColumnMetadata.named("DRPROP_Attr_Id").withIndex(27).ofType(Types.NVARCHAR).withSize(16));
        addMetadata(dRPROPAttrValue, ColumnMetadata.named("DRPROP_Attr_Value").withIndex(28).ofType(Types.NVARCHAR).withSize(2147483647));
        addMetadata(dRPROPAttrValueXML, ColumnMetadata.named("DRPROP_Attr_Value_XML").withIndex(29).ofType(Types.VARBINARY).withSize(2147483647));
        addMetadata(dRPROPDocRefAttrID, ColumnMetadata.named("DRPROP_DocRefAttrID").withIndex(26).ofType(Types.NVARCHAR).withSize(16));
        addMetadata(dRPROPId, ColumnMetadata.named("DRPROP_Id").withIndex(25).ofType(Types.NVARCHAR).withSize(16));
        addMetadata(dRPROPUsesXMLValue, ColumnMetadata.named("DRPROP_Uses_XML_Value").withIndex(30).ofType(Types.BIT).withSize(1));
    }
