...
/**
 * QDocVerProjectsInRevisionsQDB is a Querydsl query type for QDocVerProjectsInRevisionsQDB
 */
@Generated("com.querydsl.sql.codegen.MetaDataSerializer")
public class QDocVerProjectsInRevisionsQDB extends com.querydsl.sql.RelationalPathBase<QDocVerProjectsInRevisionsQDB> {

    private static final long serialVersionUID = -494215495;

    public static final QDocVerProjectsInRevisionsQDB DocVerProjectsInRevisionsQ = new QDocVerProjectsInRevisionsQDB("DocVerProjectsInRevisionsQ");
    ...
    public QDocVerProjectsInRevisionsQDB(String variable) {
        super(QDocVerProjectsInRevisionsQDB.class, forVariable(variable), "webcenter", "DocVerProjectsInRevisionsQ");
        addMetadata();
    }

    public QDocVerProjectsInRevisionsQDB(String variable, String schema, String table) {
        super(QDocVerProjectsInRevisionsQDB.class, forVariable(variable), schema, table);
        addMetadata();
    }

    public QDocVerProjectsInRevisionsQDB(String variable, String schema) {
        super(QDocVerProjectsInRevisionsQDB.class, forVariable(variable), schema, "DocVerProjectsInRevisionsQ");
        addMetadata();
    }

    public QDocVerProjectsInRevisionsQDB(Path<? extends QDocVerProjectsInRevisionsQDB> path) {
        super(path.getType(), path.getMetadata(), "webcenter", "DocVerProjectsInRevisionsQ");
        addMetadata();
    }

    public QDocVerProjectsInRevisionsQDB(PathMetadata metadata) {
        super(QDocVerProjectsInRevisionsQDB.class, metadata, "webcenter", "DocVerProjectsInRevisionsQ");
        addMetadata();
    }
