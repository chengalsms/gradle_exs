...
/**
 * QAdminProjectListQDB is a Querydsl query type for QAdminProjectListQDB
 */
@Generated("com.querydsl.sql.codegen.MetaDataSerializer")
public class QAdminProjectListQDB extends com.querydsl.sql.RelationalPathBase<QAdminProjectListQDB> {

    private static final long serialVersionUID = -1926273809;

    public static final QAdminProjectListQDB AdminProjectListQ = new QAdminProjectListQDB("AdminProjectListQ");
    ...
    public QAdminProjectListQDB(String variable) {
        super(QAdminProjectListQDB.class, forVariable(variable), "webcenter", "AdminProjectListQ");
        addMetadata();
    }

    public QAdminProjectListQDB(String variable, String schema, String table) {
        super(QAdminProjectListQDB.class, forVariable(variable), schema, table);
        addMetadata();
    }

    public QAdminProjectListQDB(String variable, String schema) {
        super(QAdminProjectListQDB.class, forVariable(variable), schema, "AdminProjectListQ");
        addMetadata();
    }

    public QAdminProjectListQDB(Path<? extends QAdminProjectListQDB> path) {
        super(path.getType(), path.getMetadata(), "webcenter", "AdminProjectListQ");
        addMetadata();
    }

    public QAdminProjectListQDB(PathMetadata metadata) {
        super(QAdminProjectListQDB.class, metadata, "webcenter", "AdminProjectListQ");
        addMetadata();
    }
