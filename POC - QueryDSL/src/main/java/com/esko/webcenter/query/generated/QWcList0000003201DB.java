...
/**
 * QWcList0000003201DB is a Querydsl query type for QWcList0000003201DB
 */
@Generated("com.querydsl.sql.codegen.MetaDataSerializer")
public class QWcList0000003201DB extends com.querydsl.sql.RelationalPathBase<QWcList0000003201DB> {

    private static final long serialVersionUID = 1414009536;

    public static final QWcList0000003201DB wcList0000003201 = new QWcList0000003201DB("WC_LIST0000003201");
    ...
    public final com.querydsl.sql.PrimaryKey<QWcList0000003201DB> _wcList0_5956f28c5010088ePk = createPrimaryKey(wcListRowID);

    public QWcList0000003201DB(String variable) {
        super(QWcList0000003201DB.class, forVariable(variable), "webcenter", "WC_LIST0000003201");
        addMetadata();
    }

    public QWcList0000003201DB(String variable, String schema, String table) {
        super(QWcList0000003201DB.class, forVariable(variable), schema, table);
        addMetadata();
    }

    public QWcList0000003201DB(String variable, String schema) {
        super(QWcList0000003201DB.class, forVariable(variable), schema, "WC_LIST0000003201");
        addMetadata();
    }

    public QWcList0000003201DB(Path<? extends QWcList0000003201DB> path) {
        super(path.getType(), path.getMetadata(), "webcenter", "WC_LIST0000003201");
        addMetadata();
    }

    public QWcList0000003201DB(PathMetadata metadata) {
        super(QWcList0000003201DB.class, metadata, "webcenter", "WC_LIST0000003201");
        addMetadata();
    }
