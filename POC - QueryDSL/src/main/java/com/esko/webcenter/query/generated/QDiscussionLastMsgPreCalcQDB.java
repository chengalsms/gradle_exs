...
/**
 * QDiscussionLastMsgPreCalcQDB is a Querydsl query type for QDiscussionLastMsgPreCalcQDB
 */
@Generated("com.querydsl.sql.codegen.MetaDataSerializer")
public class QDiscussionLastMsgPreCalcQDB extends com.querydsl.sql.RelationalPathBase<QDiscussionLastMsgPreCalcQDB> {

    private static final long serialVersionUID = 2013628418;

    public static final QDiscussionLastMsgPreCalcQDB DiscussionLastMsgPreCalcQ = new QDiscussionLastMsgPreCalcQDB("Discussion_Last_Msg_PreCalcQ");
    ...
    public QDiscussionLastMsgPreCalcQDB(String variable) {
        super(QDiscussionLastMsgPreCalcQDB.class, forVariable(variable), "webcenter", "Discussion_Last_Msg_PreCalcQ");
        addMetadata();
    }

    public QDiscussionLastMsgPreCalcQDB(String variable, String schema, String table) {
        super(QDiscussionLastMsgPreCalcQDB.class, forVariable(variable), schema, table);
        addMetadata();
    }

    public QDiscussionLastMsgPreCalcQDB(String variable, String schema) {
        super(QDiscussionLastMsgPreCalcQDB.class, forVariable(variable), schema, "Discussion_Last_Msg_PreCalcQ");
        addMetadata();
    }

    public QDiscussionLastMsgPreCalcQDB(Path<? extends QDiscussionLastMsgPreCalcQDB> path) {
        super(path.getType(), path.getMetadata(), "webcenter", "Discussion_Last_Msg_PreCalcQ");
        addMetadata();
    }

    public QDiscussionLastMsgPreCalcQDB(PathMetadata metadata) {
        super(QDiscussionLastMsgPreCalcQDB.class, metadata, "webcenter", "Discussion_Last_Msg_PreCalcQ");
        addMetadata();
    }
