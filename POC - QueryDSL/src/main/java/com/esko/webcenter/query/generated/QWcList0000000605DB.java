...
/**
 * QWcList0000000605DB is a Querydsl query type for QWcList0000000605DB
 */
@Generated("com.querydsl.sql.codegen.MetaDataSerializer")
public class QWcList0000000605DB extends com.querydsl.sql.RelationalPathBase<QWcList0000000605DB> {

    private static final long serialVersionUID = 1331820011;

    public static final QWcList0000000605DB wcList0000000605 = new QWcList0000000605DB("WC_LIST0000000605");
    ...
    public final com.querydsl.sql.PrimaryKey<QWcList0000000605DB> _wcList0_5956f28c5f20cc92Pk = createPrimaryKey(wcListRowID);

    public QWcList0000000605DB(String variable) {
        super(QWcList0000000605DB.class, forVariable(variable), "webcenter", "WC_LIST0000000605");
        addMetadata();
    }

    public QWcList0000000605DB(String variable, String schema, String table) {
        super(QWcList0000000605DB.class, forVariable(variable), schema, table);
        addMetadata();
    }

    public QWcList0000000605DB(String variable, String schema) {
        super(QWcList0000000605DB.class, forVariable(variable), schema, "WC_LIST0000000605");
        addMetadata();
    }

    public QWcList0000000605DB(Path<? extends QWcList0000000605DB> path) {
        super(path.getType(), path.getMetadata(), "webcenter", "WC_LIST0000000605");
        addMetadata();
    }

    public QWcList0000000605DB(PathMetadata metadata) {
        super(QWcList0000000605DB.class, metadata, "webcenter", "WC_LIST0000000605");
        addMetadata();
    }
