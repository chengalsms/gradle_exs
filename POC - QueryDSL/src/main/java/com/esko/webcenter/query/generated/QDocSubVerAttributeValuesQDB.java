...
/**
 * QDocSubVerAttributeValuesQDB is a Querydsl query type for QDocSubVerAttributeValuesQDB
 */
@Generated("com.querydsl.sql.codegen.MetaDataSerializer")
public class QDocSubVerAttributeValuesQDB extends com.querydsl.sql.RelationalPathBase<QDocSubVerAttributeValuesQDB> {

    private static final long serialVersionUID = -1476195628;

    public static final QDocSubVerAttributeValuesQDB DocSubVerAttributeValuesQ = new QDocSubVerAttributeValuesQDB("Doc_SubVer_Attribute_ValuesQ");
    ...
    public QDocSubVerAttributeValuesQDB(String variable) {
        super(QDocSubVerAttributeValuesQDB.class, forVariable(variable), "webcenter", "Doc_SubVer_Attribute_ValuesQ");
        addMetadata();
    }

    public QDocSubVerAttributeValuesQDB(String variable, String schema, String table) {
        super(QDocSubVerAttributeValuesQDB.class, forVariable(variable), schema, table);
        addMetadata();
    }

    public QDocSubVerAttributeValuesQDB(String variable, String schema) {
        super(QDocSubVerAttributeValuesQDB.class, forVariable(variable), schema, "Doc_SubVer_Attribute_ValuesQ");
        addMetadata();
    }

    public QDocSubVerAttributeValuesQDB(Path<? extends QDocSubVerAttributeValuesQDB> path) {
        super(path.getType(), path.getMetadata(), "webcenter", "Doc_SubVer_Attribute_ValuesQ");
        addMetadata();
    }

    public QDocSubVerAttributeValuesQDB(PathMetadata metadata) {
        super(QDocSubVerAttributeValuesQDB.class, metadata, "webcenter", "Doc_SubVer_Attribute_ValuesQ");
        addMetadata();
    }
    ...
    public void addMetadata() {
        ...
        addMetadata(bATTRDeleted, ColumnMetadata.named("BATTR_Deleted").withIndex(4).ofType(Types.SMALLINT).withSize(5).notNull());
        ...
        addMetadata(dSVATTROwnerId, ColumnMetadata.named("DSVATTR_Owner_Id").withIndex(2).ofType(Types.NVARCHAR).withSize(16).notNull());
        addMetadata(dSVATTRVersionId, ColumnMetadata.named("DSVATTR_Version_Id").withIndex(1).ofType(Types.NVARCHAR).withSize(16).notNull());
    }
